...
import 'package:list_it_social/pages/comments.dart';
import 'package:list_it_social/pages/home.dart';
import 'package:list_it_social/widgets/custom_image.dart';
...
class _PostState extends State<Post> {
  ...
  addLikeToActivityFeed() {
    //add a notification to the postOwners activity feed only if comment made by
    // other user to avoid getting notification for our own like
